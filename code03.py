...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        # 최초 실행 시 self.load_address_book() # 실행시 주소록 읽어 오기
    ...
    # def add_address_book_from_database():
    #     print("여기는 DB에서 주소록을 읽어 오는 곳 입니다.")
    #     results = self.db.getAllData()
    #     for row in results:
    #         name, phone, photo_path=row
    #         print("name{name}, phone{phone}, photo_path{photo_path}")
